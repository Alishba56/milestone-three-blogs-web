...
const subs = () => {
  return (
    ...
    <div className="grid lg:grid-cols-2 items-center lg:gap-y-6 py-10 bg-gray-400">
      <div className="max-lg:order-1 max-lg:text-center sm:p-12 p-4">
        <h2 className="text-gray-800 lg:text-5xl text-3xl font-bold lg:!leading-[56px]">Discover Blogs </h2>
        ...
        <Link href="/blogscards"><button type='button'
          className="bg-transparent border-2 border-gray-800 mt-12 transition-all text-gray-800 font-bold text-sm rounded-md px-6 py-2.5">MORE INFO</button></Link>
    ...
    <div className="grid lg:grid-cols-4  bg-gray-400  md:grid-cols-2 gap-6 px-4 py-12">
      <div className="bg-gray-100 p-6 rounded-md">
        ...
        <Link href="javascript:void(0);" className="text-blue-600 font-bold inline-block text-sm mt-4 hover:underline">Learn more</Link>
      </div>

      <div className="bg-gray-100 p-6 rounded-md">
        <svg xmlns="http://www.w3.org/2000/svg" fill="#007bff" className="w-10 h-10 mb-4 inline-block bg-white p-2 rounded-md" viewBox="0 0 512.001 512.001">
      ...
      <div className="bg-gray-100 p-6 rounded-md">
        <svg xmlns="http://www.w3.org/2000/svg" fill="#007bff" className="w-10 h-10 mb-4 inline-block bg-white p-2 rounded-md" viewBox="0 0 24 24">
      ...
      <div className="bg-gray-100 p-6 rounded-md">
        <svg xmlns="http://www.w3.org/2000/svg" fill="#007bff" className="w-10 h-10 mb-4 inline-block bg-white p-2 rounded-md" viewBox="0 0 682.667 682.667">
          <defs>
